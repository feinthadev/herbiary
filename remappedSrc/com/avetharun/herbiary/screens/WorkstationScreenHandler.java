...
public class WorkstationScreenHandler extends ScreenHandler {
    ...
    public WorkstationScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.create(playerInventory.player.method_48926(), playerInventory.player.getBlockPos()));
    }
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                if (inputRockSlot.hasStack()) {
                    stack.onCraft(player.method_48926(), player, stack.getCount());
    ...
    public ItemStack transferSlot(PlayerEntity player, int index) {
        ...
        if (slot.hasStack()) {
            ...
            if (index == 1) {
                item.onCraft(itemStack2, player.method_48926(), player);
