...
public class CampfirePotScreenHandler extends CampfirePlacementScreenHandler {
    ...
    public CampfirePotScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(42), new SimpleInventory(40), ScreenHandlerContext.create(playerInventory.player.getWorld(), playerInventory.player.getBlockPos()),playerInventory.player, null);
    }
